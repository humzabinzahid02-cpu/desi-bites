...
export const DESI_HERO_COLORS = [
  "#5C1D10", // Deep royal maroon
  "#E8A63D", // Golden turmeric / saffron amber
  "#8C2F1B", // Rich terracotta maroon
  "#FAF0D5", // Warm cream contour
  "#2B1B12", // Charcoal clay dark
  "#F4CE7F", // Golden saffron ribbon
  "#7A2818", // Spiced maroon
];
